...
//        switch_quietButton.setChecked(quiet_status);
        ...
        backButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
//				Intent intent = new Intent(Set.this,MainActivityClass.class);
...
//                intent.setAction("org.service.SetQuietService");
//
//                if (isChecked) {
...
//    public void set_buttonBluetooth() {
//        buttonBluetooth = (TextView) findViewById(R.id.buttonBluetoothOption);
//        buttonBluetooth.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(SetActivity.this, BluetoothActivity.class);
//                startActivity(intent);
//            }
//        });
//    }
